...
class DocumentType(models.TextChoices):
    ...
    ADMISSION_REQUEST = 'admission_request', 'Domanda di ammissione'
    CONTRACT_PDF_WORD = 'contract_pdf_word', 'Contratto (Word)'
    SPONSOR_CONTRACT_WORD = 'sponsor_contract_word', 'Contratto sponsor (Word)'
    ADMISSION_REQUEST_WORD = 'admission_request_word', 'Domanda (Word)'
    CLIENT_SUMMARY = 'client_summary', 'Scheda cliente'
    SIGNED_CONTRACT = 'signed_contract', 'Contratto firmato'
    INVOICE = 'invoice', 'Fattura'
    PROFORMA = 'proforma', 'Fattura proforma'
    PROFORMA_ACCONTO = 'proforma_acconto', 'Fattura proforma (acconto)'
    PROFORMA_SALDO = 'proforma_saldo', 'Fattura proforma (saldo)'
    LOGO = 'logo', 'Logo'
