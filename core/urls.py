...
urlpatterns = [
    ...
    path('evento/<uuid:pk>/da-incassare/excel/', views.da_incassare_export, name='cruscotto_da_incassare_export'),
    path('evento/<uuid:pk>/incassato/', views.incassato_evento, name='cruscotto_incassato'),
    path('evento/<uuid:pk>/incassato/excel/', views.incassato_export, name='cruscotto_incassato_export'),
    ...
    path('utility/export-sponsor/', views.export_sponsor, name='cruscotto_export_sponsor'),
    path('utility/export-contatti/', views.export_contatti, name='cruscotto_export_contatti'),
